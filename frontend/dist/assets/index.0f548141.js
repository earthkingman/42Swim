...
`,fo=r(W)`
  margin-bottom: 7px;
`,xo=()=>{const[e,n]=D.exports.useState(!1),[o,i]=D.exports.useState(!1),{user:s,isLoading:l,isError:a}=V(),[d,h]=D.exports.useState(!1);return D.exports.useEffect(()=>{se("https://swim.42seoul.io/api/users/info")},[]),u(F,{children:[t(le,{visible:d}),t(co,{onRegist:i,visible:e,onClose:n}),t(ho,{visible:o,onClose:i}),u(po,{children:[u(Co,{children:[t(ie,{to:"/",children:t(fo,{size:"h1",children:t(Gn,{})})}),t(L,{size:"14",color:"lightgrey",children:"42seoul"})]}),s&&!l?t(to,{user:s}):t(go,{children:t(mo,{onClick:()=>{location.href="https://swim.42seoul.io/api/auth/42login",h(!0),setTimeout(()=>{h(!1)},3e4)},children:"42 \uB85C\uADF8\uC778"})})]})]})},wo=r.div`
  width: 100%;
  height: 100%;
