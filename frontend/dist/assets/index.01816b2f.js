var yt=Object.defineProperty,vt=Object.defineProperties;var kt=Object.getOwnPropertyDescriptors;var le=Object.getOwnPropertySymbols;var He=Object.prototype.hasOwnProperty,Pe=Object.prototype.propertyIsEnumerable;var We=(e,n,i)=>n in e?yt(e,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[n]=i,g=(e,n)=>{for(var i in n||(n={}))He.call(n,i)&&We(e,i,n[i]);if(le)for(var i of le(n))Pe.call(n,i)&&We(e,i,n[i]);return e},v=(e,n)=>vt(e,kt(n));var k=(e,n)=>{var i={};for(var o in e)He.call(e,o)&&n.indexOf(o)<0&&(i[o]=e[o]);if(e!=null&&le)for(var o of le(e))n.indexOf(o)<0&&Pe.call(e,o)&&(i[o]=e[o]);return i};import{r as D,j as t,R as Ve,a as $,Z as _,q as _e,C as B,s as r,w as Dt,L as ee,b as Re,l as qe,c as a,F as z,d as $t,u as Ne,e as Ce,f as ge,U as At,H as me,M as R,m as Et,g as fe,h as Lt,i as zt,k as Ft,W as St,n as It,o as te,S as Mt,p as q,t as Tt,B as Ht,v as Pt,x as Wt,y as Vt}from"./vendor.e61329f1.js";const _t=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const u of l.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&o(u)}).observe(document,{childList:!0,subtree:!0});function i(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerpolicy&&(l.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?l.credentials="include":s.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(s){if(s.ep)return;s.ep=!0;const l=i(s);fetch(s.href,l)}};_t();const Rt=n=>{var e=k(n,[]);const i=location.search;return D.exports.useEffect(()=>{(async()=>{await $.get(`https://swim.42seoul.io/api/auth/authResult${i}`)})()},[i]),t(Ve,{to:"/"})},qt=async e=>await $({method:"get",url:e,withCredentials:!0}).then(i=>i.data).catch(i=>{throw i}),N=()=>{const e="https://swim.42seoul.io/api/users/info",{data:n,error:i}=_(e,qt);return{isLogin:n,user:n&&n.result?n.user:null,isLoading:!i&&!n,isError:i}},Nt=e=>$.get(e,{withCredentials:!0}).then(n=>n.data),K=()=>{const e=_e.parse(location.search).id,{data:n,error:i,mutate:o}=_(`https://swim.42seoul.io/api/pages/detail/question?questionId=${e}`,Nt),s=(d,f,x,b)=>{if(n)if(b){let w=n.questionInfo.like_count;w=x?w-1:w+1,o({questionInfo:v(g({},n.questionInfo),{like_count:w,is_like:null})},!1),$.delete(`https://swim.42seoul.io/api/posts/question/like?questionId=${f}&questionUserId=${d}&isLike=${x}`,{withCredentials:!0}).catch(y=>{throw alert(y),y}).finally(()=>o())}else{let w=n.questionInfo.like_count;w=x?w+1:w-1,o({questionInfo:v(g({},n.questionInfo),{like_count:w,is_like:x})},!1),$.post("https://swim.42seoul.io/api/posts/question/like",{questionUserId:d,questionId:f,isLike:x},{withCredentials:!0}).catch(y=>{throw alert(y),y}).finally(()=>{o()})}},l=(d,f,x,b)=>{if(b){let w=n.questionInfo.like_count;w=x?w-1:w+1;const y=n.questionInfo.answer.map(c=>(c.id===f&&(c.like_count=w,c.is_like=null),c));o({questionInfo:v(g({},n.questionInfo),{answer:y})},!1),$.delete(`https://swim.42seoul.io/api/posts/answer/like?answerId=${f}&answerUserId=${d}&isLike=${x}`,{withCredentials:!0}).catch(c=>{throw alert(c),c}).finally(()=>{o()})}else{let w=n.questionInfo.like_count;w=x?w+1:w-1;const y=n.questionInfo.answer.map(c=>(c.id===f&&(c.like_count=w,c.is_like=x),c));o({questionInfo:v(g({},n.questionInfo),{answer:y})},!1),$.post("https://swim.42seoul.io/api/posts/answer/like",{answerUserId:d,answerId:f,isLike:x},{withCredentials:!0}).catch(c=>{throw alert(c),c}).finally(()=>{o()})}},u=(d,f,x)=>{n&&$.post("https://swim.42seoul.io/api/posts/comment",{text:d,questionId:f,answerId:x},{withCredentials:!0}).catch(b=>{throw alert(b),b}).finally(()=>o())},m=(d,f,x,b)=>{if(n){const w="https://swim.42seoul.io/api/posts/comment",y=g({},n);b?y.questionInfo.answer=y.questionInfo.answer.map(c=>(c.id===b&&(c.comment=c.comment.map(I=>(I.id===f&&(I.text=d),I))),c)):y.questionInfo.answer=y.questionInfo.comment.map(c=>(c.id===f&&(c.text=d),c)),o(y,!1),$.patch(w,{text:d,commentId:f,questionId:x,answerId:b},{withCredentials:!0}).catch(c=>{throw alert(c),c}).finally(()=>o())}},p=(d,f,x)=>{if(n){const b=`https://swim.42seoul.io/api/posts/comment?commentId=${d}&questionId=${f}${x?`&answerId=${x}`:""}`,w=g({},n);x?w.questionInfo.answer=w.questionInfo.answer.map(y=>(y.id===x&&(y.comment=y.comment.filter(c=>c.id!==d)),y)):w.questionInfo.comment=w.questionInfo.comment.filter(y=>y.id!==d),o(w,!1),$.delete(b,{withCredentials:!0}).catch(y=>{throw alert(y),y}).finally(()=>o())}},C=(d,f,x,b)=>{if(n){const w=g({},n);w.questionInfo.answer.push({text:f,user:{nickname:x}}),o(w,!1),$.post("https://swim.42seoul.io/api/posts/answer",{questionId:d,text:f},{withCredentials:!0}).then(()=>b("")).catch(y=>{throw alert(y),y}).finally(()=>o())}},h=async(d,f,x)=>{try{const b=g({},n);b.is_solved=!0,b.questionInfo.answer=b.questionInfo.answer.map(y=>(y.id===f&&(y.is_solved=!0),y));const w="https://swim.42seoul.io/api/posts/answer/choice";o(b,!1),await $.post(w,{questionId:d,answerId:f,answerUserId:x},{withCredentials:!0}),o()}catch(b){throw alert(b),b}};return{question:n?n.questionInfo:null,answer:n?n.questionInfo.answer:null,isLoading:!i&&!n,isError:i,QuestionThumbPost:s,AnswerThumbPost:l,CommentPost:u,CommentEdit:m,CommentDelete:p,AnswerPost:C,ChoicePost:h}},M=(e,n=()=>!0)=>{const[i,o]=D.exports.useState(e),[s,l]=D.exports.useState(!0);return{value:i,onChange:p=>{const{target:{value:C}}=p;n(C)?o(C):l(!1)},onBlur:p=>{const C=p.target.innerText;n(C)?o(C):l(!1)},setValue:o,valid:s}},Zt={button:{primary:"#1896BD",yellow:"#FFB84D",white:"#FFFFFF",red:"#FF5D39",lightprimary:"#a7deef"},a:{primary:"#1896BD",white:"#FFFFFF",red:"#FF5D39",black:"#000000",deepgray:"#C4C4C4"},background:{white:"#FFFFFF",lightgrey:"#F3F3F3"},text:{primary:"#1896BD",white:"#FFFFFF",yellow:"#FFB84D",red:"#FF5D39",black:"#000000",lightgrey:"#a6a6a6",grey:"#565656",deepgray:"#C4C4C4"},tag:{primary:"#1896BD"},primary:"#1896BD",lightprimary:"#a7deef",yellow:"#FFB84D",white:"#FFFFFF",red:"#FF5D39",deepgray:"#C4C4C4",lightgrey:"#EAEAEA",black:"#000000",lightblack:"#545454",lightyelloew:"#FFDCA8"},A={color:Zt},Ut=B`
...
`,Jt=r.div`
  ...
  ${Gt};
`,we=i=>{var o=i,{children:e}=o,n=k(o,["children"]);return t(Jt,v(g({},n),{children:e}))};function X(e){const n=new Date,i=new Date(e),o=Math.floor((n.getTime()-i.getTime())/1e3/60);if(o<1)return"\uBC29\uAE08\uC804";if(o<60)return`${o}\uBD84\uC804`;const s=Math.floor(o/60);if(s<24)return`${s}\uC2DC\uAC04\uC804`;const l=Math.floor(o/60/24);return l<365?`${l}\uC77C\uC804`:`${Math.floor(l/365)}\uB144\uC804`}const Xt=r.p`
  padding-bottom: 8rem;
...
`,Yt=new Re.exports.Converter({tables:!0,simplifiedAutoLink:!0,strikethrough:!0,tasklists:!0,extensions:[qe({pre:!0})]}),Ze=i=>{var o=i,{children:e}=o,n=k(o,["children"]);return a(z,{children:[t(Xt,v(g({},n),{dangerouslySetInnerHTML:{__html:Yt.makeHtml(e)}})),t("script",{src:"/path/to/highlight.min.js"}),t("script",{children:"hljs.highlightAll();"}),t("link",{rel:"stylesheet",href:"https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.3.1/styles/default.min.css"})]})},Ot=B`
  ${({size:e})=>e&&B`
      font-size: ${e+"px"};
...
`,en=r.p`
  ...
  word-break: break-all;
  ${Ot}
`,E=i=>{var o=i,{children:e}=o,n=k(o,["children"]);return t(en,v(g({},n),{children:e}))};var tn="/assets/cat0.7e5dd6fb.jpeg";const xe={xsm:{size:"25px"},sm:{size:"40px"},lg:{size:"120px"}},nn=B`
  ${({size:e})=>e&&B`
      width: ${xe[e].size};
      height: ${xe[e].size};
      background-size: ${xe[e].size} auto;
    `}
  ${({color:e})=>e&&B`
      background-color: ${e};
    `}
...
`,dn=r.div`
  ...
  ${cn}
`,U=i=>{var o=i,{children:e}=o,n=k(o,["children"]);return t(dn,v(g({},n),{children:e}))},Ue=r.div`
  display: flex;
...
`,wn=r(Z)`
  position: relative;
`,Ke=({created_at:e,questionId:n,answerId:i,user:o,text:s,userEmail:l,id:u})=>{const{CommentEdit:m,CommentDelete:p}=K(),C=X(e),[h,d]=D.exports.useState(!1),[f,x]=D.exports.useState(!1),{value:b,setValue:w,onBlur:y}=M(s),c=D.exports.useRef(),I=async()=>{confirm("\uB313\uAE00\uC744 \uC0AD\uC81C\uD558\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?")&&p(u,n,i),d(!1)},V=()=>{x(!0),setTimeout(function(){c.current.focus()},1),d(!h)},j=async()=>{m(b,u,n,i),x(!1)};return a(hn,{children:[a(pn,{children:[t(E,{weight:"bold",size:"14",children:o.nickname}),t(E,{size:"14",color:"grey",children:C})]}),a(Cn,{children:[t(gn,{contentEditable:f,onBlur:y,ref:c,suppressContentEditableWarning:!0,children:b}),o.email===l?a(z,{children:[a(wn,{visible:!f,children:[t(un,{onClick:()=>d(!h)}),t(mn,{show:h,children:a(fn,{children:[t(je,{small:!0,onClick:V,children:"\uC218\uC815"}),t(je,{small:!0,onClick:I,children:"\uC0AD\uC81C"})]})})]}),a(Z,{visible:f,children:[t(F,{fontcolor:"deepgray",onClick:()=>{w(s),x(!1)},style:{marginRight:"1rem"},children:"\uCDE8\uC18C"}),t(F,{onClick:j,children:"\uC644\uB8CC"})]})]}):null]})]},u)},xn=B`
  ${({border:e})=>e===!1&&B`
      border: none;
    `}
`,Bn=r.input`
...
`,Ge=o=>{var s=o,{questionId:e,answerId:n}=s,i=k(s,["questionId","answerId"]);const{user:l,isLoading:u,isError:m}=N(),{CommentPost:p}=K(),{value:C,onChange:h,setValue:d}=M("");if(u)return m?t("div",{children:"Err.."}):t("div",{children:"Load..."});{const f=x=>{x.preventDefault(),C?l?(p(C,e,n),d("")):alert("\uB313\uAE00 \uC791\uC131\uC744 \uC704\uD574 \uB85C\uADF8\uC778\uC744 \uD574\uC8FC\uC138\uC694"):alert("\uB313\uAE00\uC6B8 \uC785\uB825\uD574\uC8FC\uC138\uC694")};return a(bn,v(g({onSubmit:f},i),{children:[t(yn,{placeholder:"\uB313\uAE00\uC744 \uC785\uB825\uD558\uC138\uC694",value:C,border:!1,onChange:h}),t(vn,{fontcolor:"primary",underline:!1,onClick:f,children:"\uB313\uAE00 \uC785\uB825"})]}))}},kn=r.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  align-items: flex-end;
...
`,Je=r(Z)`
  ...
  padding-bottom: 2rem;
`,qn=C=>{var h=C,{is_solved:e,like_count:n,is_like:i,is_chosen:o,isChoosable:s,comment:l,id:u,user:m}=h,p=k(h,["is_solved","like_count","is_like","is_chosen","isChoosable","comment","id","user"]);const{AnswerThumbPost:d,ChoicePost:f}=K(),{user:x}=N(),[b,w]=D.exports.useState(!1),[y,c]=D.exports.useState(!1),{value:I,setValue:V}=M(p.text),j=!!x,gt=Ne(),se=new URLSearchParams(gt.search).get("id"),Me=H=>{if(!j)return alert("\uB85C\uADF8\uC778 \uD6C4 \uC88B\uC544\uC694\uB97C \uB20C\uB7EC\uC8FC\uC138\uC694!");y===!1?(c(!0),i===H?d(m.id,u,H,!0):i===!H?alert("\uC88B\uC544\uC694/\uC2EB\uC5B4\uC694\uB294 \uD558\uB098\uB9CC \uAC00\uB2A5\uD569\uB2C8\uB2E4!"):d(m.id,u,H,!1),setTimeout(()=>{c(!1)},1e4)):alert("\uC88B\uC544\uC694/\uC2EB\uC5B4\uC694 \uBC84\uD2BC \uD074\uB9AD\uC740 10\uCD08\uC5D0 \uD55C\uBC88\uC73C\uB85C \uC81C\uD55C\uB429\uB2C8\uB2E4.")},mt=()=>{Me(!0)},ft=()=>{Me(!1)},wt=()=>{confirm("\uD574\uB2F9 \uB2F5\uBCC0\uC744 \uCC44\uD0DD\uD558\uACA0\uC2B5\uB2C8\uAE4C? \uCC44\uD0DD \uD6C4\uC5D0\uB294 \uCDE8\uC18C\uAC00 \uBD88\uAC00\uB2A5\uD569\uB2C8\uB2E4.")&&se&&f(parseInt(se),u,m.id)},xt=async()=>{const H="https://swim.42seoul.io/api/posts/answer",Te={questionId:se,answerId:u,text:I};await $.patch(H,Te,{withCredentials:!0}).then(Jr=>{alert("\uB2F5\uBCC0 \uC218\uC815\uC774 \uC644\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4!")}),w(!1)},Bt=async()=>{const H=`https://swim.42seoul.io/api/posts/answer?questionId=${se}&answerId=${u}`;await $.delete(H,{withCredentials:!0}).then(Te=>{alert("\uB2F5\uBCC0 \uC0AD\uC81C\uAC00 \uC644\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4!")}),w(!1)},bt=l==null?void 0:l.map(H=>t(Ke,g({userEmail:x==null?void 0:x.email,answerId:u},H),H.id));return a(_n,v(g({},p),{children:[t(ve,{is_solved:e,is_chosen:o,like_count:n,is_like:i,isChoosable:s,onUpClick:mt,onDownClick:ft,onChooseClick:wt}),t(Z,{width:"100%",visible:!b,children:a(we,{isChecked:o,children:[t(sn,v(g({},p),{id:u,user:m})),a(Je,{visible:j?(m==null?void 0:m.email)===(x==null?void 0:x.email):!1,children:[t(F,{fontcolor:"deepgray",small:!0,style:{marginRight:"1rem"},onClick:()=>w(!0),children:"\uC218\uC815"}),t(F,{onClick:Bt,fontcolor:"deepgray",small:!0,children:"\uC0AD\uC81C"})]}),bt,t(Ge,{answerId:u})]})}),t(Z,{width:"100%",height:"100%",visible:b,children:a(Rn,{children:[t(ae,{value:I,setValue:V}),a(Je,{visible:!0,children:[t(F,{fontcolor:"deepgray",small:!0,style:{marginRight:"1rem"},onClick:()=>w(!1),children:"\uCDE8\uC18C"}),t(F,{onClick:xt,fontcolor:"primary",bold:!0,small:!0,children:"\uD655\uC778"})]})]})})]}))},ue={sm:{height:"41px",fontSize:"16px"},lg:{width:"449px",height:"60px",fontSize:"18px"}},Nn=B`
  ${({theme:e,color:n})=>n&&B`
...
`,Zn=r.button`
  ...
  ${Nn}
`,T=i=>{var o=i,{children:e}=o,n=k(o,["children"]);return t(Zn,v(g({},n),{children:e}))},Xe={bold:{background:"#000000",height:"3px"},light:{background:"#EAEAEA",height:"1px"}},Un={horizontal:"rotate(0deg)",vertical:"rotate(90deg)"},Qn=B`
  ${({weight:e})=>e&&B`
...
`;r(E)`
  white-space: pre-line;
`;const ri=({user:e,created_at:n,title:i,hashtag:o,text:s})=>{const l=X(n),u=o==null?void 0:o.map(m=>t(ne,{name:m.name},m.name));return a(ii,{children:[a(Oe,{children:[t(Q,{size:"h1",children:i}),t(E,{size:"14",color:"grey",children:l})]}),a(Oe,{children:[t(G,v(g({},e),{size:"sm"})),t(oi,{children:u})]}),t(Ze,{children:s})]})},si=r.div`
  display: flex;
  justify-content: space-between;
`,li=r(Z)`
  display: flex;
...
`,ke=u=>{var m=u,{children:e,onClose:n,visible:i,title:o,subtitle:s}=m,l=k(m,["children","onClose","visible","title","subtitle"]);return t(Ei,{visible:i,children:a(vi,v(g({},l),{children:[t(Di,{onClick:n,children:t(ki,{})}),t($i,{size:"h1",children:o}),t(Ai,{children:s}),e]}))})};ke.defaultProps={visible:!0};const Li=o=>{var s=o,{onClose:e,onRegist:n}=s,i=k(s,["onClose","onRegist"]);const[l,u]=D.exports.useState({email:"",password:""}),{email:m,password:p}=l,[C,h]=D.exports.useState(!1),d=async()=>{try{(await $.post("https://swim.42seoul.io/api/auth/login",l,{withCredentials:!0})).status===200?(me("https://swim.42seoul.io/api/users/info"),e(!1)):alert("\uB85C\uADF8\uC778 \uC2E4\uD328!")}catch(b){alert("\uC774\uBA54\uC77C \uB610\uB294 \uBE44\uBC00\uBC88\uD638 \uC624\uB958")}u({email:"",password:""})},f=b=>{const{name:w,value:y}=b.target;u(v(g({},l),{[w]:y}))},x=()=>{location.href="https://localhost:5000/auth/42login",e(!1),h(!0)};return a(z,{children:[t(et,{visible:C}),t(ke,v(g({onClose:()=>e(!1),title:"\uB85C\uADF8\uC778",subtitle:"\uC774\uBA54\uC77C\uB85C \uB85C\uADF8\uC778"},i),{children:a(nt,{height:"392px",children:[a(it,{height:"265px",children:[t(W,{name:"email",value:m,onChange:f,placeholder:"\uC774\uBA54\uC77C\uC744 \uC785\uB825\uD558\uC138\uC694"}),t(W,{name:"password",value:p,type:"password",onChange:f,placeholder:"\uBE44\uBC00\uBC88\uD638\uB97C \uC785\uB825\uD558\uC138\uC694"}),t(T,{onClick:d,size:"lg",children:"\uB85C\uADF8\uC778"}),t(F,{onClick:x,fontcolor:"primary",underline:!0,children:"42seoul \uACC4\uC815\uC73C\uB85C \uB85C\uADF8\uC778"})]}),t(F,{onClick:()=>{n(!0),e(!1)},fontcolor:"black",children:"\uC544\uC9C1 \uD68C\uC6D0\uC774 \uC544\uB2C8\uC2E0\uAC00\uC694?"})]})}))]})},zi=i=>{var o=i,{onClose:e}=o,n=k(o,["onClose"]);const[s,l]=D.exports.useState({nickname:"",email:"",password:"",confirm_pass:""}),{nickname:u,email:m,password:p,confirm_pass:C}=s,h=x=>{const{name:b,value:w}=x.target;if(l(v(g({},s),{[b]:w})),b==="confirm_pass"&&p!==""){const y=document.getElementById("diffpass");y.style.display="inherit",p===C?(y.innerHTML="\uBE44\uBC00\uBC88\uD638\uAC00 \uC77C\uCE58\uD569\uB2C8\uB2E4!",y.style.color="blue"):(y.innerHTML="\uBE44\uBC00\uBC88\uD638\uAC00 \uB2E4\uB985\uB2C8\uB2E4!",y.style.color="red")}},d=x=>{if(x.target.name==="confirm_pass"&&p!==""){const b=document.getElementById("diffpass");b.style.display="inherit",p===C?(b.innerHTML="\uBE44\uBC00\uBC88\uD638\uAC00 \uC77C\uCE58\uD569\uB2C8\uB2E4!",b.style.color="blue"):(b.innerHTML="\uBE44\uBC00\uBC88\uD638\uAC00 \uB2E4\uB985\uB2C8\uB2E4!",b.style.color="red")}},f=async()=>{const x=await $.post("https://swim.42seoul.io/api/auth/signup",s,{withCredentials:!0});l({nickname:"",email:"",password:"",confirm_pass:""}),x.data.result===!0&&e(!1),location.reload()};return t(ke,v(g({title:"\uD68C\uC6D0\uAC00\uC785",subtitle:"\uC774\uBA54\uC77C\uB85C \uD68C\uC6D0\uAC00\uC785",height:"712px",onClose:()=>e(!1)},n),{children:a(nt,{height:"420px",children:[a(it,{height:"300px",children:[t(W,{name:"nickname",value:u,onChange:h,placeholder:"\uB2C9\uB124\uC784"}),t(W,{name:"email",value:m,onChange:h,placeholder:"\uC774\uBA54\uC77C"}),t(W,{name:"password",value:p,type:"password",onChange:h,placeholder:"\uBE44\uBC00\uBC88\uD638"}),t(W,{name:"confirm_pass",value:C,type:"password",onChange:h,onKeyUp:d,onBlur:d,placeholder:"\uBE44\uBC00\uBC88\uD638 \uD655\uC778"}),t(E,{size:"14",id:"diffpass",style:{width:"449px",marginLeft:"2rem",display:"none"},children:"HiddenBox"})]}),t(T,{onClick:f,size:"lg",children:"\uD68C\uC6D0\uAC00\uC785"})]})}))},Fi=r.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
...
`;r.div`
  margin-bottom: 4rem;
`;const _i=s=>{var l=s,{question:e,answer:n,answerWriting:i}=l,o=k(l,["question","answer","answerWriting"]);return a("div",v(g({},o),{children:[t(Vi,{children:e}),n,i]}))},Ri=n=>{var e=k(n,[]);const{question:i,answer:o,isLoading:s,isError:l}=K(),{user:u,isLoading:m}=N();let p;return!s&&!m&&(p=o==null?void 0:o.map(C=>t(qn,g({isChoosable:u?i.user.email===u.email:!1,is_solved:i.is_solved},C),C.id))),l?t(z,{children:"err"}):t(J,v(g({},e),{children:t(_i,{question:t(ai,{}),answer:p,answerWriting:t(On,{})})}))},qi=r.input`
  width: 100%;
  font-size: 18px;
  background-color: inherit;
  margin: 3rem 0rem;
...
`,Ki=r.div`
  ...
  justify-content: flex-end;
  align-items: center;
`,Gi=()=>{const{question:e,isLoading:n,isError:i}=K(),o=h=>/^[\w]*$/g.test(h)&&h.length<20,s=h=>h.length<40,l=M("",o),u=M("",s),m=M(""),[p,C]=D.exports.useState([]);if(D.exports.useEffect(()=>{const h=e==null?void 0:e.hashtag.map(d=>d.name);C(h),u.setValue(e?e.title:""),m.setValue(e?e.text:"")},[]),!n&&!i){const h=async d=>{if(d.preventDefault(),!u.value||!m.value){alert("\uC81C\uBAA9\uACFC \uB0B4\uC6A9\uC744 \uBAA8\uB450 \uC644\uC131\uD574\uC8FC\uC138\uC694.");return}try{(await $.patch("https://swim.42seoul.io/api/posts/question",{questionId:e.id,title:u.value,hashtag:p,text:m.value},{withCredentials:!0})).status===200?(alert("\uC9C8\uBB38 \uC218\uC815\uC774 \uC644\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4!"),location.href=`/detail?id=${e.id}`):(alert("\uC9C8\uBB38 \uC791\uC131\uC744 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4."),location.href="/")}catch(f){alert(f)}};return a(Ui,{children:[t(Qi,{value:u.value,placeholder:"\uC9C8\uBB38\uD560 \uC81C\uBAA9\uC744 \uC785\uB825\uD558\uC138\uC694",onChange:u.onChange}),t(ot,{inputChange:l.onChange,value:l.value,setValue:l.setValue,tag:p,setTag:C,placeholder:"\uD0DC\uADF8\uB97C \uC785\uB825\uD558\uC138\uC694 ex) ft_printf"}),t(ce,{weight:"bold",width:"4rem"}),a(ji,{children:[t(ae,{value:m.value,setValue:m.setValue,placeHolder:"\uC9C8\uBB38\uC744 \uC0C1\uC138\uD558\uAC8C \uC801\uC5B4\uC8FC\uC138\uC694!"}),a(Ki,{children:[t(F,{fontcolor:"deepgray",style:{fontSize:"16px",marginRight:"2rem"},to:`/detail?id=${e.id}`,children:"\uCDE8\uC18C"}),t(T,{size:"sm",onClick:h,fontColor:"white",children:"\uC9C8\uBB38 \uC791\uC131\uD558\uAE30"})]})]})]})}else return i?t("div",{children:"err.."}):t("div",{children:"loading"})},Ji=n=>{var e=k(n,[]);return t(J,v(g({},e),{children:t(Gi,{})}))},Xi=e=>a("svg",v(g({width:"21",height:"20",viewBox:"0 0 21 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},e),{children:[t("circle",{cx:"8",cy:"8",r:"6.5",stroke:"black",strokeWidth:"3"}),t("path",{d:"M13.5 13L19 18.5",stroke:"black",strokeWidth:"3"})]})),Yi=r.div`
  width: 60%;
  height: 43px;
  border-radius: 20px;
...
`,De=s=>{var l=s,{onChange:e,onSearch:n,search:i}=l,o=k(l,["onChange","onSearch","search"]);const[u,m]=D.exports.useState(!1),p={border:`1px solid ${A.color.primary}`},C=h=>{h.key==="Enter"&&n()};return t(z,{children:a(Yi,v(g({style:u?p:{}},o),{children:[t(Oi,{placeholder:"\uAC80\uC0C9\uD560 \uB0B4\uC6A9\uC744 \uC785\uB825\uD558\uC138\uC694",value:i,border:!1,onKeyPress:C,onChange:e,onFocus:()=>m(!0),onBlur:()=>m(!1)}),t(eo,{onClick:n,children:t(Xi,{})})]}))})},st=r.div`
  display: flex;
  flex-direction: column;
  justify-content: space-around;
  width: 70%;
...
`,Y=r(E)``;r(P)`
  width: 10%;
  height: 100%;
`;const Se=s=>{var l=s,{name:e,count:n,color:i}=l,o=k(l,["name","count","color"]);return a(Qe,v(g({width:"40px",height:"60px"},o),{children:[t(E,{weight:"bold",size:"18",color:i,children:e}),t(E,{weight:"bold",size:"18",color:i,children:n})]}))},no=f=>{var x=f,{id:e,title:n,text:i,is_solved:o,photo:s,nickname:l,answer_cnt:u=1,like_count:m,view_count:p,created_at:C,hashtag:h}=x,d=k(x,["id","title","text","is_solved","photo","nickname","answer_cnt","like_count","view_count","created_at","hashtag"]);i=i.replace(/^\s*`{3}\w*/gm,"").replace(/[`#*~_>]/g,"").replace(/^!\[[\w.]*\]\([\w.:/-]+\)/gi,""),h.length>5&&(h=h.slice(0,3),h.push({name:"..."}));const b=()=>{const w="https://swim.42seoul.io/api/pages/question/viewCount";$.post(w,{questionId:e},{withCredentials:!0})};return a($e,v(g({},d),{children:[a(Ae,{size:"lg",children:[t(ee,{to:`/detail?id=${e}`,onClick:b,children:t(Ee,{size:"h2",children:n})}),t(Le,{size:"18",weight:"normal",color:"grey",children:i}),a(ie,{children:[a(L,{children:[t(ze,{size:"14",weight:"normal",color:"grey",children:X(C)}),h.map((w,y)=>t(ne,{name:w==null?void 0:w.name,style:{marginTop:"0px"}},y))]}),t(G,{size:"sm",photo:s,nickname:l,id:0})]})]}),a(Fe,{children:[t(Se,{name:"\uB2F5\uBCC0",count:u,color:o?"primary":"black"}),t(Se,{name:"\uCD94\uCC9C",count:m}),t(Se,{name:"\uC870\uD68C",count:p})]})]}))},io=f=>{var x=f,{id:e,title:n,text:i,is_solved:o,photo:s,nickname:l,answer_cnt:u=1,like_count:m,view_count:p,created_at:C,hashtag:h}=x,d=k(x,["id","title","text","is_solved","photo","nickname","answer_cnt","like_count","view_count","created_at","hashtag"]);i=i==null?void 0:i.replace(/^\s*`{3}\w*/gm,"").replace(/[`#*~_>]/g,"").replace(/^!\[[\w.]*\]\([\w.:/-]+\)/gi,""),(h==null?void 0:h.length)>2&&(h=h.slice(0,2),h.push({name:"..."}));const b=()=>{const w="https://swim.42seoul.io/api/pages/question/viewCount";$.post(w,{questionId:e},{withCredentials:!0})};return t($e,v(g({size:"xsm"},d),{children:a(Ae,{size:"sm",children:[t(ee,{to:`/detail?id=${e}`,onClick:b,children:t(Ee,{size:"h3",children:n})}),t(Le,{style:{lineHeight:"18px"},size:"12",weight:"normal",color:"grey",children:i}),t(ie,{children:a(L,{children:[t(ze,{size:"12",weight:"normal",color:"grey",children:X(C)}),h==null?void 0:h.map((w,y)=>t(ne,{name:w==null?void 0:w.name,style:{marginTop:"0px"},size:"12"},y))]})}),t(ie,{children:a(ut,{children:[a(Fe,{size:"sm",children:[a(Y,{size:"12",weight:"normal",color:o?"primary":"black",children:["\uB2F5\uBCC0 ",u]}),a(Y,{size:"12",weight:"normal",color:"black",children:["\uCD94\uCC9C ",m]}),a(Y,{size:"12",weight:"normal",color:"black",children:["\uC870\uD68C ",p]})]}),t(G,{size:"xsm",photo:s,nickname:l,id:0})]})})]})}))},oo=f=>{var x=f,{id:e,title:n,text:i,is_solved:o,photo:s,nickname:l,answer_cnt:u=1,like_count:m,view_count:p,created_at:C,hashtag:h}=x,d=k(x,["id","title","text","is_solved","photo","nickname","answer_cnt","like_count","view_count","created_at","hashtag"]);i=i==null?void 0:i.replace(/^\s*`{3}\w*/gm,"").replace(/[`#*~_>]/g,"").replace(/^!\[[\w.]*\]\([\w.:/-]+\)/gi,""),(h==null?void 0:h.length)>2&&(h=h.slice(0,2),h.push({name:"..."}));const b=()=>{const w="https://swim.42seoul.io/api/pages/question/viewCount";$.post(w,{questionId:e},{withCredentials:!0})};return t($e,v(g({size:"sm"},d),{children:a(Ae,{size:"sm",children:[t(ee,{to:`/detail?id=${e}`,onClick:b,children:t(Ee,{size:"h2",children:n})}),t(Le,{style:{lineHeight:"18px"},size:"14",weight:"normal",color:"grey",children:i}),t(ie,{children:a(L,{children:[t(ze,{size:"14",weight:"normal",color:"grey",children:X(C)}),h.map((w,y)=>t(ne,{name:w==null?void 0:w.name,style:{marginTop:"0px"}},y))]})}),t(ie,{children:a(ut,{children:[a(Fe,{size:"sm",children:[a(Y,{size:"14",weight:"normal",color:o?"primary":"black",children:["\uB2F5\uBCC0 ",u]}),a(Y,{size:"14",weight:"normal",color:"black",children:["\uCD94\uCC9C ",m]}),a(Y,{size:"14",weight:"normal",color:"black",children:["\uC870\uD68C ",p]})]}),t(G,{size:"sm",photo:s,nickname:l,id:0})]})})]})}))},de=n=>{var e=k(n,[]);return a(z,{children:[t(R,{minWidth:1024,children:t(no,g({},e))}),t(R,{minWidth:768,maxWidth:1023,children:t(oo,g({},e))}),t(R,{maxWidth:767,children:t(io,g({},e))})]})},ro=r.ul`
  /* width: 380px; */
  /* height: 41px; */
  display: flex;
  justify-content: flex-start;
...
`,S=s=>{var l=s,{active:e,children:n,onTabClick:i}=l,o=k(l,["active","children","onTabClick"]);return t(so,v(g({style:e?{color:"black",transition:"color 0.5s ease"}:void 0,onClick:i},o),{children:n}))},O=i=>{var o=i,{children:e}=o,n=k(o,["children"]);return t(ro,v(g({},n),{children:e}))};O.Item=S;const lo=e=>{const[n,i]=D.exports.useState(!1);return t("svg",v(g({width:"15",height:"25",viewBox:"0 0 15 25",fill:"none",style:{marginLeft:"1rem"},xmlns:"http://www.w3.org/2000/svg",onMouseEnter:l=>{i(!0),l.target.style.cursor="pointer",l.stopPropagation()},onMouseLeave:()=>{i(!1)}},e),{children:t("path",{d:"M1.225 23.5507C1.8375 24.1532 2.825 24.1532 3.4375 23.5507L13.825 13.332C14.3125 12.8524 14.3125 12.0777 13.825 11.5982L3.4375 1.37952C2.825 0.776976 1.8375 0.776976 1.225 1.37952C0.612503 1.98206 0.612503 2.95351 1.225 3.55605L10.275 12.4712L1.2125 21.3864C0.612503 21.9767 0.612503 22.9604 1.225 23.5507Z",fill:n?A.color.lightblack:A.color.black})}))},ao=e=>{const[n,i]=D.exports.useState(!1);return t("svg",v(g({width:"15",height:"25",viewBox:"0 0 15 25",fill:"none",style:{marginRight:"1rem"},xmlns:"http://www.w3.org/2000/svg",onMouseEnter:l=>{i(!0),l.target.style.cursor="pointer",l.stopPropagation()},onMouseLeave:()=>{i(!1)}},e),{children:t("path",{d:"M13.775 1.39185C13.1625 0.789306 12.175 0.789306 11.5625 1.39185L1.17501 11.6105C0.687512 12.0901 0.687512 12.8648 1.17501 13.3443L11.5625 23.563C12.175 24.1655 13.1625 24.1655 13.775 23.563C14.3875 22.9604 14.3875 21.989 13.775 21.3865L4.72501 12.4713L13.7875 3.55609C14.3875 2.96584 14.3875 1.9821 13.775 1.39185Z",fill:n?A.color.lightblack:A.color.black})}))},uo=r.div`
  ...
  justify-content: center;
  align-items: center;
`,co=s=>{var l=s,{number:e,active:n,onClick:i}=l,o=k(l,["number","active","onClick"]);const[u,m]=D.exports.useState(!1),p=d=>{m(!0),d.target.style.color=A.color.lightblack,d.stopPropagation()},C=d=>{m(!1),d.target.style.color=A.color.black},h={display:"flex",justifyContent:"space-around",alignItems:"center"};return t(Be,v(g({onClick:i,size:"sm",color:n?A.color.primary:A.color.white,style:h,onMouseEnter:p,onMouseLeave:C},o),{children:e}))};function ho(e,n){const i=10*(n.current-1)+1;let o;return e<=10?o=e:i+9>=e?o=e-i+1:o=10,Array(o).fill(i).map((s,l)=>s+l)}function ct(e,n){let i=parseInt(n/e);return n%e==0&&(i=i-1),i+1}const he=l=>{var u=l,{page:e=1,limit:n=8,onPage:i,questionCount:o=10}=u,s=k(u,["page","limit","onPage","questionCount"]);const m=ct(n,o),p=D.exports.useRef(1),C=()=>{if(e===1){alert("\uD398\uC774\uC9C0\uAC00 \uC874\uC7AC\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4!");return}e%10==1&&(p.current-=1),i(e-1)},h=()=>{if(e===m){alert("\uD398\uC774\uC9C0\uAC00 \uC874\uC7AC\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4!");return}e%10==0&&(p.current+=1),i(e+1)};return a(uo,v(g({},s),{children:[t(ao,{onClick:C}),t(L,{children:ho(m,p).map(d=>t(co,{number:d,onClick:()=>i(d),active:e===d},d))}),t(lo,{onClick:h})]}))},po=async e=>await $.get(e).then(i=>i.data).catch(i=>{throw fe(i),Error()}),Co=async e=>await $.get(e).then(i=>i.data.questionList).catch(i=>{throw fe(i),Error()}),go=async()=>await $.get("https://swim.42seoul.io/api/pages/list/question?pageNumber=1").then(n=>n.data).catch(n=>{throw fe(n),Error()}),mo=(e,n)=>n&&!n.length?null:`https://swim.42seoul.io/api/pages/list/question?pageNumber=${e+1}`,fo=()=>{const{data:e,size:n,setSize:i,error:o,isValidating:s}=Et(mo,Co);return{question:e,page:n,setPage:i,isLoading:!o&&!e,isError:o,isRefreshing:s&&e&&e.length===n}},wo=()=>{const{data:e,error:n}=_("questionCount",go,{revalidateIfStale:!1,revalidateOnFocus:!1,revalidateOnReconnect:!1}),i=8;return{questionCount:e==null?void 0:e.questionCount,pageSize:ct(i,e==null?void 0:e.questionCount),isLoading:!n&&!e,isError:n}},xo=(e,n)=>{const i=e===0?`https://swim.42seoul.io/api/pages/list/question?pageNumber=${n}`:e===1?`https://swim.42seoul.io/api/pages/list/question/like?pageNumber=${n}`:e===2?`https://swim.42seoul.io/api/pages/list/question/unsolved?pageNumber=${n}`:e===3?`https://swim.42seoul.io/api/pages/list/question?pageNumber=${n}`:"",{data:o,error:s}=_(i,po);return{question:o,isLoading:!s&&!o,isError:s}},pe=r.div`
	width: 100%;
...
`,Eo=r.ul`
  ...
  gap: 28px;
`;function dt(n){var e=k(n,[]);const[i,o]=D.exports.useState(1),{tagList:s,isLoading:l}=bo(i),u=Lt();if(l)return t("div",{children:"loading"});{const m=s==null?void 0:s.hashTagList.map(p=>t(Do,g({onClick:()=>{u.push({pathname:`/tag/${p.name}`,state:{hashtagId:p.id,hashtagName:p.name}})}},p),p.id));return a($o,v(g({},e),{children:[a(Ao,{children:["\uBAA8\uB4E0 \uD0DC\uADF8 (",s==null?void 0:s.hashTagListCount,")\uAC1C"]}),t(Eo,{children:m}),t(P,{height:"115px",children:t(he,{limit:30,questionCount:s==null?void 0:s.hashTagListCount,page:i,onPage:o})})]}))}}function Lo(e){const[n,i]=D.exports.useState(!1);return D.exports.useEffect(()=>{if(!e.current)return;const o=new IntersectionObserver(([s])=>i(s.isIntersecting));return o.observe(e.current),()=>{o.disconnect()}},[]),n}const zo=n=>{var e=k(n,[]);var y;const i=D.exports.useRef(null),o=Lo(i),[s,l]=D.exports.useState(0),{question:u,page:m,setPage:p,isLoading:C,isError:h,isRefreshing:d}=fo(),f=((y=u==null?void 0:u[0])==null?void 0:y.length)===0,x=u?[].concat(...u):[],{pageSize:b}=wo(),w=f||o&&m>=b;return D.exports.useEffect(()=>{o&&!w&&!d&&p(m+1)},[o,d]),h?t("div",{children:"Error!!"}):a(st,{children:[a(O,v(g({},e),{children:[t(S,{active:s===0,onTabClick:()=>l(0),children:"\uCD5C\uC2E0\uC21C"}),t(S,{active:s===1,onTabClick:()=>l(1),children:"\uC778\uAE30\uC21C"}),t(S,{active:s===2,onTabClick:()=>l(2),children:"\uB2F5\uBCC0\uD544\uC694"}),t(S,{active:s===3,onTabClick:()=>l(3),children:"\uD0DC\uADF8"})]})),s===3?t(dt,{}):a(at,{children:[C?[...Array(8)].map((c,I)=>t(lt,{children:t(pe,{})},I)):x&&x.map((c,I)=>{var V,j;return t(de,g({id:c==null?void 0:c.id,title:c==null?void 0:c.title,text:c==null?void 0:c.text,photo:(V=c==null?void 0:c.user)==null?void 0:V.photo,nickname:(j=c==null?void 0:c.user)==null?void 0:j.nickname,is_solved:c==null?void 0:c.is_solved,answer_cnt:c==null?void 0:c.answer_count,like_count:c==null?void 0:c.like_count,view_count:c==null?void 0:c.view_count,hashtag:c==null?void 0:c.hashtag,created_at:c==null?void 0:c.created_at},e),I)}),t("div",{ref:i}),w?t(to,{children:"\uB9C8\uC9C0\uB9C9 \uD398\uC774\uC9C0 \uC785\uB2C8\uB2E4!"}):t(z,{})]})]})},Fo=n=>{var e=k(n,[]);const[i,o]=D.exports.useState(0),[s,l]=D.exports.useState(1),{question:u,isLoading:m,isError:p}=xo(i,s);return p?t("div",{children:"Error!!"}):a(st,{children:[a(O,v(g({},e),{children:[t(S,{active:i===0,onTabClick:()=>o(0),children:"\uCD5C\uC2E0\uC21C"}),t(S,{active:i===1,onTabClick:()=>o(1),children:"\uC778\uAE30\uC21C"}),t(S,{active:i===2,onTabClick:()=>o(2),children:"\uB2F5\uBCC0\uD544\uC694"}),t(S,{active:i===3,onTabClick:()=>o(3),children:"\uD0DC\uADF8"})]})),i===3?t(dt,{}):a(at,{children:[m?[...Array(8)].map((C,h)=>t(lt,{children:t(pe,{})},h)):(u==null?void 0:u.questionList)&&(u==null?void 0:u.questionList.map((C,h)=>{var d;return t(de,g({id:C.id,title:C.title,text:C.text,photo:C.user.photo,nickname:(d=C==null?void 0:C.user)==null?void 0:d.nickname,is_solved:C.is_solved,answer_cnt:C.answer_count,like_count:C.like_count,view_count:C.view_count,hashtag:C.hashtag,created_at:C.created_at},e),h)})),t(P,{height:"115px",children:t(he,{questionCount:u==null?void 0:u.questionCount,page:s,onPage:l})})]})]})},So=n=>{var e=k(n,[]);return a(z,{children:[t(R,{minWidth:768,children:t(Fo,g({},e))}),t(R,{maxWidth:767,children:t(zo,g({},e))})]})};r.div`
  display: flex;
  flex-direction: column;
  justify-content: space-between;
  width: 90%;
...
`,xr=({tlPanel:e,trPanel:n,bPanel:i})=>a(pr,{children:[a(Cr,{children:[t(gr,{children:e}),t(mr,{}),t(fr,{children:n})]}),t(wr,{children:i})]}),Br=r.div`
  width: 100%;
  height: 100px;
  padding-bottom: 1.5rem;
  display: flex;
...
`,Ie=r(T)`
  width: 153px;
`,Er=n=>{var e=k(n,[]);const{user:i,isLoading:o,isError:s}=N(),{value:l,onChange:u,setValue:m}=M(i==null?void 0:i.nickname),[p,C]=D.exports.useState(!1);if(s)return alert("\uB85C\uADF8\uC778\uC744 \uD574\uC8FC\uC138\uC694"),t(Ve,{to:"/"});if(o)return t("div",{children:"loading..."});const h=()=>{const b=document.getElementById("uploadImg");b==null||b.click()},d=async()=>{const b=new FormData,w=document.getElementById("uploadImg").files[0],y="https://swim.42seoul.io/api/users/image";b.append("imgFile",w),await $.patch(y,b,{withCredentials:!0}).then(c=>{alert("\uC774\uBBF8\uC9C0 \uC5C5\uB85C\uB4DC\uB97C \uC131\uACF5\uD588\uC2B5\uB2C8\uB2E4!")}),location.reload()},f=async()=>{const b="https://swim.42seoul.io/api/users/image";await $.delete(b,{withCredentials:!0}).then(w=>{alert("\uC774\uBBF8\uC9C0\uB97C \uC815\uC0C1\uC801\uC73C\uB85C \uC0AD\uC81C\uD588\uC2B5\uB2C8\uB2E4!")}),location.reload()},x=async()=>{const b="https://swim.42seoul.io/api/users/nickname",w={nickname:l};await $.patch(b,w,{withCredentials:!0}).then(y=>{alert("\uB2C9\uB124\uC784 \uC218\uC815\uC774 \uC644\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4!")}),me("https://swim.42seoul.io/api/users/info"),C(!1)};return t(J,v(g({},e),{children:t(xr,{tlPanel:a(z,{children:[t(Be,{size:"lg",img:(i==null?void 0:i.image)?i.image:null}),t(Ie,{size:"sm",color:"primary",shadow:!0,onClick:h,children:"\uC774\uBBF8\uC9C0 \uC5C5\uB85C\uB4DC"}),t("form",{id:"imgform",method:"patch",encType:"application/json",style:{display:"none"},children:t("input",{id:"uploadImg",type:"file",onChange:d})}),t(Ie,{size:"sm",color:"white",shadow:!0,onClick:f,children:"\uC774\uBBF8\uC9C0 \uC81C\uAC70"})]}),trPanel:a(z,{children:[a(Z,{visible:!p,children:[t(Q,{size:"h1",children:i==null?void 0:i.nickname}),t(ce,{weight:"bold",width:"4rem"}),t(F,{fontcolor:"primary",underline:!0,to:"#",onClick:()=>{m(i==null?void 0:i.nickname),C(!0)},children:"\uC218\uC815"})]}),a(Ar,{visible:p,children:[t($r,{value:l||"",onChange:u}),t(T,{size:"sm",color:"lightprimary",shadow:!0,onClick:x,children:"\uC218\uC815\uD558\uAE30"}),t(F,{fontcolor:"deepgray",underline:!0,to:"#",onClick:()=>C(!1),children:"\uCDE8\uC18C"})]})]}),bPanel:a(z,{children:[t(Ct,{name:"\uC774\uBA54\uC77C",value:i.email,etc:t(F,{fontcolor:"primary",underline:!0,children:"\uC218\uC815"}),desc:"\uD68C\uC6D0 \uC778\uC99D \uB610\uB294 \uC2DC\uC2A4\uD15C\uC5D0\uC11C \uBC1C\uC1A1\uD558\uB294 \uC774\uBA54\uC77C\uC744 \uC218\uC2E0\uD558\uB294 \uC8FC\uC18C\uC785\uB2C8\uB2E4."}),t(Ct,{name:"\uBE44\uBC00\uBC88\uD638 \uBCC0\uACBD",value:t(F,{fontcolor:"primary",underline:!0,children:"\uBCC0\uACBD\uD558\uAE30"}),desc:"\uBE44\uBC00\uBC88\uD638 \uBCC0\uACBD\uD558\uAE30 \uBC84\uD2BC\uC744 \uB204\uB974\uBA74 \uC704\uC758 \uC774\uBA54\uC77C\uB85C  \uBCC0\uACBD\uD558\uAE30 \uD398\uC774\uC9C0\uAC00 \uBC1C\uC1A1\uB429\uB2C8\uB2E4."}),t(Ie,{size:"sm",fontColor:"white",color:"red",shadow:!0,children:"\uD68C\uC6D0 \uD0C8\uD1F4"})]})})}))},Lr=r.div`
  width: 100%;
  height: 100%;
`,zr=r(rt)`
  width: 100%;
...
`,Fr=r.div`
  ...
  flex-direction: column;
  align-items: flex-end;
`,Sr=()=>{const e='\uC9C8\uBB38\uC744 \uB0A8\uACA8\uBCF4\uC138\uC694!\n  ```C\n  printf("helloWord");\n  ```',n=d=>/[\w]*$/g.test(d)&&d.length<20,i=d=>d.length<40,o=M("",n),s=M("",i),l=M(e),[u,m]=D.exports.useState([]),{isLoading:p,user:C}=N();D.exports.useEffect(()=>{!p&&!C&&(alert("\uB85C\uADF8\uC778 \uD6C4 \uC9C8\uBB38 \uC791\uC131\uC774 \uAC00\uB2A5\uD569\uB2C8\uB2E4."),location.href="/")},[C]);const h=async d=>{if(d.preventDefault(),!s.value||!l.value){alert("\uC81C\uBAA9\uACFC \uB0B4\uC6A9\uC744 \uBAA8\uB450 \uC644\uC131\uD574\uC8FC\uC138\uC694.");return}try{const f=await $.post("https://swim.42seoul.io/api/posts/question",{title:s.value,hashtag:u,text:l.value},{withCredentials:!0});f.status===200?(alert("\uC9C8\uBB38 \uC791\uC131\uC774 \uC644\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4!"),location.href=`/detail?id=${f.data.id}`):(alert("\uC9C8\uBB38 \uC791\uC131\uC744 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4."),location.href="/")}catch(f){alert(f)}};return a(Lr,{children:[t(zr,{value:s.value,placeholder:"\uC9C8\uBB38\uD560 \uC81C\uBAA9\uC744 \uC785\uB825\uD558\uC138\uC694",onChange:s.onChange}),t(ot,{inputChange:o.onChange,value:o.value,setValue:o.setValue,tag:u,setTag:m,placeholder:"\uD0DC\uADF8\uB97C \uC785\uB825\uD558\uC138\uC694 ex) ft_printf"}),t(ce,{weight:"bold",width:"4rem",style:{marginBottom:"3rem"}}),a(Fr,{children:[t(ae,{value:l.value,setValue:l.setValue,placeHolder:"\uC9C8\uBB38\uC744 \uC0C1\uC138\uD558\uAC8C \uC801\uC5B4\uC8FC\uC138\uC694!"}),t(T,{size:"sm",onClick:h,fontColor:"white",children:"\uC9C8\uBB38 \uC791\uC131\uD558\uAE30"})]})]})},Ir=n=>{var e=k(n,[]);return t(J,v(g({},e),{children:t(Sr,{})}))},Mr=St`
  body {
