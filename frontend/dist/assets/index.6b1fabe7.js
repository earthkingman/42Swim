...
`,Je=r(N)`
  ...
  padding-bottom: 2rem;
`,Nn=C=>{var h=C,{is_solved:e,like_count:n,is_like:i,is_chosen:o,isChoosable:s,comment:l,id:u,user:m}=h,p=k(h,["is_solved","like_count","is_like","is_chosen","isChoosable","comment","id","user"]);const{AnswerThumbPost:d,ChoicePost:f}=K(),{user:x}=q(),[b,w]=D.exports.useState(!1),[y,c]=D.exports.useState(!1),{value:M,setValue:V}=I(p.text),Q=!!x,mt=Ue(),le=new URLSearchParams(mt.search).get("id"),He=H=>{if(!Q)return alert("\uB85C\uADF8\uC778 \uD6C4 \uC88B\uC544\uC694\uB97C \uB20C\uB7EC\uC8FC\uC138\uC694!");y===!1?(c(!0),i===H?d(m.id,u,H,!0):i===!H?alert("\uC88B\uC544\uC694/\uC2EB\uC5B4\uC694\uB294 \uD558\uB098\uB9CC \uAC00\uB2A5\uD569\uB2C8\uB2E4!"):d(m.id,u,H,!1),setTimeout(()=>{c(!1)},1e4)):alert("\uC88B\uC544\uC694/\uC2EB\uC5B4\uC694 \uBC84\uD2BC \uD074\uB9AD\uC740 10\uCD08\uC5D0 \uD55C\uBC88\uC73C\uB85C \uC81C\uD55C\uB429\uB2C8\uB2E4.")},ft=()=>{He(!0)},wt=()=>{He(!1)},xt=()=>{confirm("\uD574\uB2F9 \uB2F5\uBCC0\uC744 \uCC44\uD0DD\uD558\uACA0\uC2B5\uB2C8\uAE4C? \uCC44\uD0DD \uD6C4\uC5D0\uB294 \uCDE8\uC18C\uAC00 \uBD88\uAC00\uB2A5\uD569\uB2C8\uB2E4.")&&le&&f(parseInt(le),u,m.id)},Bt=async()=>{const H="https://swim.42seoul.io/api/posts/answer",We={questionId:le,answerId:u,text:M};await $.patch(H,We,{withCredentials:!0}).then(os=>{alert("\uB2F5\uBCC0 \uC218\uC815\uC774 \uC644\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4!")}),w(!1)},bt=async()=>{const H=`https://swim.42seoul.io/api/posts/answer?questionId=${le}&answerId=${u}`;await $.delete(H,{withCredentials:!0}).then(We=>{alert("\uB2F5\uBCC0 \uC0AD\uC81C\uAC00 \uC644\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4!")}),w(!1)},yt=l==null?void 0:l.map(H=>t(Ge,g({userEmail:x==null?void 0:x.email,answerId:u},H),H.id));return a(Zn,v(g({},p),{children:[t(ke,{is_solved:e,is_chosen:o,like_count:n,is_like:i,isChoosable:s,onUpClick:ft,onDownClick:wt,onChooseClick:xt}),t(N,{width:"100%",visible:!b,children:a(xe,{isChecked:o,children:[t(ln,v(g({},p),{id:u,user:m})),a(Je,{visible:Q?(m==null?void 0:m.email)===(x==null?void 0:x.email):!1,children:[t(F,{fontcolor:"deepgray",small:!0,style:{marginRight:"1rem"},onClick:()=>w(!0),children:"\uC218\uC815"}),t(F,{onClick:bt,fontcolor:"deepgray",small:!0,children:"\uC0AD\uC81C"})]}),yt,t(Ye,{answerId:u})]})}),t(N,{width:"100%",height:"100%",visible:b,children:a(qn,{children:[t(ue,{value:M,setValue:V}),a(Je,{visible:!0,children:[t(F,{fontcolor:"deepgray",small:!0,style:{marginRight:"1rem"},onClick:()=>w(!1),children:"\uCDE8\uC18C"}),t(F,{onClick:Bt,fontcolor:"primary",bold:!0,small:!0,children:"\uD655\uC778"})]})]})})]}))},ce={sm:{height:"41px",fontSize:"16px"},lg:{width:"449px",height:"60px",fontSize:"18px"}},Un=B`
  ${({theme:e,color:n})=>n&&B`
...
`,O=r(A)``;r(W)`
  width: 10%;
  height: 100%;
`;const Ie=s=>{var l=s,{name:e,count:n,color:i}=l,o=k(l,["name","count","color"]);return a(Qe,v(g({width:"40px",height:"60px"},o),{children:[t(A,{weight:"bold",size:"18",color:i,children:e}),t(A,{weight:"bold",size:"18",color:i,children:n})]}))},co=f=>{var x=f,{id:e,title:n,text:i,is_solved:o,photo:s,nickname:l,answer_cnt:u=1,like_count:m,view_count:p,created_at:C,hashtag:h}=x,d=k(x,["id","title","text","is_solved","photo","nickname","answer_cnt","like_count","view_count","created_at","hashtag"]);i=i.replace(/^\s*`{3}\w*/gm,"").replace(/[`#*~_>]/g,"").replace(/^!\[[\w.]*\]\([\w.:/-]+\)/gi,""),h.length>5&&(h=h.slice(0,3),h.push({name:"..."}));const b=()=>{const w="https://swim.42seoul.io/api/pages/question/viewCount";$.post(w,{questionId:e},{withCredentials:!0})};return a(Ae,v(g({},d),{children:[a(Ee,{size:"lg",children:[t(te,{to:`/detail?id=${e}`,onClick:b,children:t(ze,{size:"h2",children:n})}),t(Fe,{size:"18",weight:"normal",color:"grey",children:i}),a(oe,{children:[a(E,{children:[t(Se,{size:"14",weight:"normal",color:"grey",children:X(C)}),h.map((w,y)=>t(ie,{name:w==null?void 0:w.name,style:{marginTop:"0px"}},y))]}),t(G,{size:"sm",photo:s,nickname:l,id:0})]})]}),a(Me,{children:[t(Ie,{name:"\uB2F5\uBCC0",count:u,color:o?"primary":"black"}),t(Ie,{name:"\uCD94\uCC9C",count:m}),t(Ie,{name:"\uC870\uD68C",count:p})]})]}))},ho=f=>{var x=f,{id:e,title:n,text:i,is_solved:o,photo:s,nickname:l,answer_cnt:u=1,like_count:m,view_count:p,created_at:C,hashtag:h}=x,d=k(x,["id","title","text","is_solved","photo","nickname","answer_cnt","like_count","view_count","created_at","hashtag"]);i=i==null?void 0:i.replace(/^\s*`{3}\w*/gm,"").replace(/[`#*~_>]/g,"").replace(/^!\[[\w.]*\]\([\w.:/-]+\)/gi,""),(h==null?void 0:h.length)>2&&(h=h.slice(0,2),h.push({name:"..."}));const b=()=>{const w="https://swim.42seoul.io/api/pages/question/viewCount";$.post(w,{questionId:e},{withCredentials:!0})};return t(Ae,v(g({size:"xsm"},d),{children:a(Ee,{size:"sm",children:[t(te,{to:`/detail?id=${e}`,onClick:b,children:t(ze,{size:"h3",children:n})}),t(Fe,{style:{lineHeight:"18px"},size:"12",weight:"normal",color:"grey",children:i}),t(oe,{children:a(E,{children:[t(Se,{size:"12",weight:"normal",color:"grey",children:X(C)}),h==null?void 0:h.map((w,y)=>t(ie,{name:w==null?void 0:w.name,style:{marginTop:"0px"},size:"12"},y))]})}),t(oe,{children:a(ct,{children:[a(Me,{size:"sm",children:[a(O,{size:"12",weight:"normal",color:o?"primary":"black",children:["\uB2F5\uBCC0 ",u]}),a(O,{size:"12",weight:"normal",color:"black",children:["\uCD94\uCC9C ",m]}),a(O,{size:"12",weight:"normal",color:"black",children:["\uC870\uD68C ",p]})]}),t(G,{size:"xsm",photo:s,nickname:l,id:0})]})})]})}))},po=f=>{var x=f,{id:e,title:n,text:i,is_solved:o,photo:s,nickname:l,answer_cnt:u=1,like_count:m,view_count:p,created_at:C,hashtag:h}=x,d=k(x,["id","title","text","is_solved","photo","nickname","answer_cnt","like_count","view_count","created_at","hashtag"]);i=i==null?void 0:i.replace(/^\s*`{3}\w*/gm,"").replace(/[`#*~_>]/g,"").replace(/^!\[[\w.]*\]\([\w.:/-]+\)/gi,""),(h==null?void 0:h.length)>2&&(h=h.slice(0,2),h.push({name:"..."}));const b=()=>{const w="https://swim.42seoul.io/api/pages/question/viewCount";$.post(w,{questionId:e},{withCredentials:!0})};return t(Ae,v(g({size:"sm"},d),{children:a(Ee,{size:"sm",children:[t(te,{to:`/detail?id=${e}`,onClick:b,children:t(ze,{size:"h2",children:n})}),t(Fe,{style:{lineHeight:"18px"},size:"14",weight:"normal",color:"grey",children:i}),t(oe,{children:a(E,{children:[t(Se,{size:"14",weight:"normal",color:"grey",children:X(C)}),h.map((w,y)=>t(ie,{name:w==null?void 0:w.name,style:{marginTop:"0px"}},y))]})}),t(oe,{children:a(ct,{children:[a(Me,{size:"sm",children:[a(O,{size:"14",weight:"normal",color:o?"primary":"black",children:["\uB2F5\uBCC0 ",u]}),a(O,{size:"14",weight:"normal",color:"black",children:["\uCD94\uCC9C ",m]}),a(O,{size:"14",weight:"normal",color:"black",children:["\uC870\uD68C ",p]})]}),t(G,{size:"sm",photo:s,nickname:l,id:0})]})})]})}))},he=n=>{var e=k(n,[]);return a(z,{children:[t(R,{minWidth:1024,children:t(co,g({},e))}),t(R,{minWidth:768,maxWidth:1023,children:t(po,g({},e))}),t(R,{maxWidth:767,children:t(ho,g({},e))})]})},Co=r.ul`
  /* width: 380px; */
  /* height: 41px; */
  display: flex;
  justify-content: flex-start;
